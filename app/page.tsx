...
function NextRaceHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-[360px] md:min-h-[220px]" style={{ height: "100%" }}>
...
export default function HomePage() {
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen pb-28 md:pb-6" style={{ backgroundColor: "#13131f" }}>
      ...
      {/* ── Header ── */}
      <header className="relative z-10 w-full px-6 md:px-10 pt-8 pb-4">
      ...
      <div
        className="relative z-10 flex-1 flex flex-col md:flex-row md:items-start gap-4 px-4 md:px-10 pb-2 w-full"
      >
        {/* ── Next Race Hero ── */}
