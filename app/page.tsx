              ...
              >
                {turn.active ? (
                  ...
                  >
                    ...
                    <span style={{ fontSize: "11px", fontWeight: 700, color: "white", textShadow: "0 1px 4px rgba(0,0,0,0.9)", lineHeight: 1.2, textAlign: "center", whiteSpace: "nowrap" }}>
                      {turn.label}
                    </span>
                    {turn.sublabel && (
                      <span style={{ fontSize: "9px", color: "rgba(255,255,255,0.55)", textShadow: "0 1px 4px rgba(0,0,0,0.9)", lineHeight: 1.2, textAlign: "center", whiteSpace: "nowrap" }}>
                        {turn.sublabel}
                      </span>
                    )}
                  </button>
                  ...
                  <div className="flex flex-col items-center" style={{ gap: "4px" }}>
                    <div style={{ width: "38px", height: "38px", borderRadius: "50%", backgroundColor: "#252525", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>
                      {turn.icon}
                    </div>
                    <span style={{ fontSize: "9px", color: "#4a4a4a", lineHeight: 1.2, textAlign: "center", whiteSpace: "nowrap" }}>
                      {turn.label}
                    </span>
                  </div>
                )}
