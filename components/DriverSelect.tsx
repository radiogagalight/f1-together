...
export default function DriverSelect({ label, value, isSaved, disabled, onPrediction, points, resultStatus, pointsEarned, boosted, boostAvailable, onBoost }: Props) {
  ...
  const carbonBg = "repeating-linear-gradient(45deg, rgba(255,255,255,0.055) 0px, rgba(255,255,255,0.055) 1px, transparent 1px, transparent 10px), repeating-linear-gradient(-45deg, rgba(255,255,255,0.055) 0px, rgba(255,255,255,0.055) 1px, transparent 1px, transparent 10px)";
