...
export const CIRCUIT_INTEL: CircuitCharacter[] = [
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "Long straights into Turns 6 and 14 give Active Aero a full effect and generate multiple passes per lap.",
    safetyCarLikelihood: "Medium",
  ...
  },
  {
    ...
    trackType: "Street",
    overtaking: "Occasional",
    overtakingNote: "Two Active Aero zones help, but the tight infield limits overtaking to Turn 1 and the final hairpin.",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "Multiple hairpins and a long pit straight with Active Aero create consistent overtaking opportunities.",
    safetyCarLikelihood: "High",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Occasional",
    overtakingNote: "The long Active Aero run down to Turn 1 and the final chicane are the main passing spots on this technical circuit.",
    safetyCarLikelihood: "Low",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "The short layout and multiple Active Aero zones make overtaking common, especially after safety-car restarts.",
    safetyCarLikelihood: "Medium",
    safetyCarNote: "High-speed corners and close racing create regular incidents, particularly in wet Austrian conditions.",
    poleToWinPct: 60,
    poleToWinNote: "Overtake Mode is very effective here; a quicker car can pass even from a few places back.",
  ...
  },
  {
    ...
    trackFavours: "Low-drag, powerful cars with strong straight-line speed and stable braking into the chicanes. Engine mode and Active Aero efficiency matter more than downforce here.",
  ...
  },
  {
    ...
    trackType: "Street",
    overtaking: "Occasional",
    overtakingNote: "Early indications suggest the Madrid layout has long straights with Active Aero zones to promote overtaking.",
    safetyCarLikelihood: "High",
  ...
  },
  {
    ...
    trackType: "Street",
    overtaking: "Occasional",
    overtakingNote: "The long front straight and castle section hairpin are the prime overtaking zones under Active Aero.",
    safetyCarLikelihood: "High",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "The long back straight into a hard-braking hairpin is a proven passing zone, backed up by two further Active Aero zones.",
    safetyCarLikelihood: "High",
  ...
  },
  {
    ...
    poleToWinPct: 60,
    poleToWinNote: "Multiple Active Aero zones make overtaking easier than most circuits; strategy is often the decider.",
    ...
    trackFavours: "Cars with a compliant ride over bumps and strong high-speed change of direction through the Sector 1 esses. Good traction out of the Sector 3 hairpins also pays off under Overtake Mode.",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Occasional",
    overtakingNote: "The long main straight and Peraltada give Active Aero a boost, but the stadium section limits passing.",
    safetyCarLikelihood: "Medium",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "Interlagos is a short, flowing circuit; lapped traffic and Active Aero zones create frequent action.",
    safetyCarLikelihood: "High",
  ...
  },
  {
    ...
    trackType: "Street",
    overtaking: "Frequent",
    overtakingNote: "The 1.9 km Strip straight gives cars one of the longest Active Aero straights in F1 — overtaking is common.",
    safetyCarLikelihood: "Medium",
    safetyCarNote: "Inexperienced night-time street circuit with cold track temperatures leads to occasional incidents.",
    poleToWinPct: 55,
    poleToWinNote: "The sheer length of the straight means faster cars can attack from well behind under Overtake Mode.",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Frequent",
    overtakingNote: "Lusail's smooth surface and multiple long straights give Active Aero maximum effect for passing.",
    safetyCarLikelihood: "Medium",
  ...
  },
  {
    ...
    trackType: "Permanent",
    overtaking: "Occasional",
    overtakingNote: "Active Aero on the long main straight helps, but the tight hairpin and narrow sections limit other opportunities.",
    safetyCarLikelihood: "Low",
